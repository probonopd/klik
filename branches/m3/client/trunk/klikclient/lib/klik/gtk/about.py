...
class KlikAbout(object):
	...
	def show(self):
		...
		dlg.set_name("klik")
		#icon = gtk.icon_theme_get_default().load_icon("application-x-extension-cmg", 48, 0)
		...
		dlg.set_logo(icon)
		dlg.set_authors(["Simon Peter <probono@myrealbox.com>", "Kurt Pfeifle <pfeifle@kde.org>", "Jason Taylor <killerkiwi2005@gmail.com>", "Lionel Tricon <lionel.tricon@free.fr>", "Niall Walsh <niallw@gmail.com>","RazZziel <razielmine@gmail.com","","Thanks to all testers and contributors","in #klik on irc.freenode.net"])
